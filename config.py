...
def cfg():
    ...
    path = {
        'log_dir': '/root/autodl-tmp/RPT-main/runs',
        'CHAOST2': {'data_dir': '/root/autodl-tmp/RPT-main/data/CHAOST2'},
        'SABS': {'data_dir': '/root/autodl-tmp/RPT-main/data/SABS'},
        'CMR': {'data_dir': '/root/autodl-tmp/RPT-main/data/CMR'},
    }
