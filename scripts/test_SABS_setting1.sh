...
do
  ...
  do
    ...
    #RELOAD_MODEL_PATH="/home/gbj168/RPT-main/exps_on_SABS_setting1/RPT_train_SABS_cv${EVAL_FOLD}/1/snapshots/checkpoints.pth"
    RELOAD_MODEL_PATH="/root/autodl-tmp/RPT-main/exps_on_SABS_fewshot_setting1/RPT_train_SABS_cv4/1/snapshots/checkpoints.pth"
